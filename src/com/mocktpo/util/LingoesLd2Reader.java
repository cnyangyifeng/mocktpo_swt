...
public class LingoesLd2Reader {
    ...
    private static long decompress(final String inflatedFile, final ByteBuffer data, final int offset,
    ...
    private static SensitiveStringDecoder[] detectEncodings(final ByteBuffer inflatedBytes,
    ...
    private static void inflate(final ByteBuffer dataRawBytes, final List<Integer> deflateStreams,
    ...
    private static void readDefinitionData(final ByteBuffer inflatedBytes, final int offsetWords,
    ...
    public static void main(String[] args) throws IOException {
        ...
        // String ld2File = "/Users/yangyifeng/Dictionaries/Collins COBUILD Advanced Learner's Dictionary 5th Edition.ld2";
        String ld2File = "/Users/yangyifeng/Dictionaries/Oxford Advanced Learner's English-Chinese Dictionary.ld2";
