...
public interface MT {
    ...
    int COLOR_GRAY = 6;
    int COLOR_GREEN = 7;
    int COLOR_LIGHT_GRAY = 8;
    int COLOR_LIGHT_YELLOW = 9;
    int COLOR_LIGHTER_GRAY = 10;
    int COLOR_RED = 11;
    int COLOR_TEXT_GRAY = 12;
    int COLOR_WHITE = 13;
    ...
    int IMAGE_LOGO = 45;
    int IMAGE_PAUSE_TEST = 46;
    int IMAGE_PAUSE_TEST_HOVER = 47;
    int IMAGE_SETTINGS = 48;
    int IMAGE_SPLASH = 49;
}
