...
public interface MT {
    ...
    int IMAGE_SYSTEM_EXPORT = 3013;
    int IMAGE_SYSTEM_EXPORT_HOVER = 3014;
    int IMAGE_SYSTEM_IMPORT = 3015;
    int IMAGE_SYSTEM_IMPORT_HOVER = 3016;
    int IMAGE_SYSTEM_NEW_TEST = 3017;
    int IMAGE_SYSTEM_NEW_TEST_HOVER = 3018;
    int IMAGE_SYSTEM_PASTE = 3019;
    int IMAGE_SYSTEM_PASTE_HOVER = 3020;
