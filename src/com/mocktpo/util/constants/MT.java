...
public interface MT {
    ...
    int IMAGE_READY_TO_ANSWER = 334;
    int IMAGE_RETURN = 335;
    int IMAGE_RETURN_HOVER = 336;
    int IMAGE_RETURN_TO_QUESTION = 337;
    int IMAGE_RETURN_TO_QUESTION_HOVER = 338;
    int IMAGE_REVIEW = 339;
    int IMAGE_REVIEW_HOVER = 340;
    int IMAGE_REVIEW_OVAL = 341;
    int IMAGE_REVIEW_OVAL_HOVER = 342;
    int IMAGE_REVIEW_OVAL_DISABLED = 343;
    int IMAGE_SHOW_TIME = 344;
    int IMAGE_SHOW_TIME_HOVER = 345;
    int IMAGE_SHOW_TIME_DISABLED = 346;
    int IMAGE_SPLASH = 347;
    int IMAGE_VIEW_QUESTION = 348;
    int IMAGE_VIEW_QUESTION_HOVER = 349;
    int IMAGE_VIEW_TEXT = 350;
    int IMAGE_VIEW_TEXT_HOVER = 351;
    int IMAGE_VOLUME_OVAL = 352;
    int IMAGE_VOLUME_OVAL_HOVER = 353;
    int IMAGE_UNBOXED = 354;
    int IMAGE_UNCHECKED = 355;
