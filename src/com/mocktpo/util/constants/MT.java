...
public interface MT {
    ...
    int IMAGE_SYSTEM_STEP_LISTENING = 3035;
    int IMAGE_SYSTEM_STEP_LISTENING_HOVER = 3036;
    int IMAGE_SYSTEM_STEP_PREVIEW = 3037;
    int IMAGE_SYSTEM_STEP_PREVIEW_HOVER = 3038;
    int IMAGE_SYSTEM_STEP_READING = 3039;
    int IMAGE_SYSTEM_STEP_READING_HOVER = 3040;
    int IMAGE_SYSTEM_STEP_SPEAKING = 3041;
    int IMAGE_SYSTEM_STEP_SPEAKING_HOVER = 3042;
    int IMAGE_SYSTEM_STEP_WRITING = 3043;
    int IMAGE_SYSTEM_STEP_WRITING_HOVER = 3044;
    int IMAGE_SYSTEM_UNBOXED = 3045;
