...
public interface MT {
    ...
    int IMAGE_CONTINUE_OVAL_HOVER = 316;
    ...
    int IMAGE_REVIEW_OVAL_HOVER = 351;
    int IMAGE_REVIEW_OVAL_DISABLED = 352;
    int IMAGE_SHOW_TIME = 353;
    int IMAGE_SHOW_TIME_HOVER = 354;
    int IMAGE_SHOW_TIME_DISABLED = 355;
    int IMAGE_SPLASH = 356;
    int IMAGE_STOP_RECORDING = 357;
    int IMAGE_STOP_RECORDING_HOVER = 358;
    int IMAGE_VIEW_QUESTION = 359;
    int IMAGE_VIEW_QUESTION_HOVER = 360;
    int IMAGE_VIEW_TEXT = 361;
    int IMAGE_VIEW_TEXT_HOVER = 362;
    int IMAGE_VOLUME_OVAL = 363;
    int IMAGE_VOLUME_OVAL_HOVER = 364;
