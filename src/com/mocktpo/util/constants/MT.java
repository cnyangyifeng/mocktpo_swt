...
public interface MT {
    ...
    int IMAGE_SYSTEM_NEW_CATEGORY_CHART_QUESTION = 422;
    int IMAGE_SYSTEM_NEW_CATEGORY_CHART_QUESTION_HOVER = 423;
    int IMAGE_SYSTEM_NEW_INSERT_TEXT_QUESTION = 424;
    int IMAGE_SYSTEM_NEW_INSERT_TEXT_QUESTION_HOVER = 425;
    int IMAGE_SYSTEM_NEW_PASSAGE = 426;
    int IMAGE_SYSTEM_NEW_PASSAGE_HOVER = 427;
    int IMAGE_SYSTEM_NEW_PROSE_SUMMARY_QUESTION = 428;
    int IMAGE_SYSTEM_NEW_PROSE_SUMMARY_QUESTION_HOVER = 429;
    int IMAGE_SYSTEM_NEW_QUESTION = 430;
    int IMAGE_SYSTEM_NEW_QUESTION_HOVER = 431;

    int IMAGE_SYSTEM_NEW_TEST = 422;
    int IMAGE_SYSTEM_NEW_TEST_HOVER = 423;
    int IMAGE_SYSTEM_NEW_TEST_PAPER = 424;
    int IMAGE_SYSTEM_NEW_TEST_PAPER_HOVER = 425;
    int IMAGE_SYSTEM_PASTE = 426;
    int IMAGE_SYSTEM_PASTE_HOVER = 427;
    int IMAGE_SYSTEM_REPORT = 428;
    int IMAGE_SYSTEM_REPORT_HOVER = 429;
    int IMAGE_SYSTEM_SAVE = 430;
    int IMAGE_SYSTEM_SAVE_HOVER = 431;
    int IMAGE_SYSTEM_STAR = 432;
    int IMAGE_SYSTEM_STAR_OUTLINE = 433;
    int IMAGE_SYSTEM_STEP_GENERAL = 434;
    int IMAGE_SYSTEM_STEP_GENERAL_CHECKED = 435;
    int IMAGE_SYSTEM_STEP_GENERAL_DISABLED = 436;
    int IMAGE_SYSTEM_STEP_GENERAL_HOVER = 437;
    int IMAGE_SYSTEM_STEP_LISTENING = 438;
    int IMAGE_SYSTEM_STEP_LISTENING_CHECKED = 439;
    int IMAGE_SYSTEM_STEP_LISTENING_DISABLED = 440;
    int IMAGE_SYSTEM_STEP_LISTENING_HOVER = 441;
    int IMAGE_SYSTEM_STEP_PREVIEW = 442;
    int IMAGE_SYSTEM_STEP_PREVIEW_CHECKED = 443;
    int IMAGE_SYSTEM_STEP_PREVIEW_DISABLED = 444;
    int IMAGE_SYSTEM_STEP_PREVIEW_HOVER = 445;
    int IMAGE_SYSTEM_STEP_READING = 446;
    int IMAGE_SYSTEM_STEP_READING_CHECKED = 447;
    int IMAGE_SYSTEM_STEP_READING_DISABLED = 448;
    int IMAGE_SYSTEM_STEP_READING_HOVER = 449;
    int IMAGE_SYSTEM_STEP_SPEAKING = 450;
    int IMAGE_SYSTEM_STEP_SPEAKING_CHECKED = 451;
    int IMAGE_SYSTEM_STEP_SPEAKING_DISABLED = 452;
    int IMAGE_SYSTEM_STEP_SPEAKING_HOVER = 453;
    int IMAGE_SYSTEM_STEP_WRITING = 454;
    int IMAGE_SYSTEM_STEP_WRITING_CHECKED = 455;
    int IMAGE_SYSTEM_STEP_WRITING_DISABLED = 456;
    int IMAGE_SYSTEM_STEP_WRITING_HOVER = 457;
    int IMAGE_SYSTEM_UNBOXED = 458;
