...
public interface MT {
    ...
    int IMAGE_SYSTEM_DELETE = 3013;
    int IMAGE_SYSTEM_DELETE_HOVER = 3014;
    int IMAGE_SYSTEM_EXPORT = 3015;
    int IMAGE_SYSTEM_EXPORT_HOVER = 3016;
    int IMAGE_SYSTEM_IMPORT = 3017;
    int IMAGE_SYSTEM_IMPORT_HOVER = 3018;
    int IMAGE_SYSTEM_MY_NOTEBOOK = 3019;
    int IMAGE_SYSTEM_MY_NOTEBOOK_HOVER = 3020;
    int IMAGE_SYSTEM_NEW_TEST = 3021;
    int IMAGE_SYSTEM_NEW_TEST_HOVER = 3022;
    int IMAGE_SYSTEM_PASTE = 3023;
    int IMAGE_SYSTEM_PASTE_HOVER = 3024;
    int IMAGE_SYSTEM_REFERENCE_ANSWERS = 3025;
    int IMAGE_SYSTEM_REFERENCE_ANSWERS_HOVER = 3026;
    int IMAGE_SYSTEM_REPORT = 3027;
    int IMAGE_SYSTEM_REPORT_HOVER = 3028;
    int IMAGE_SYSTEM_STAR = 3029;
    int IMAGE_SYSTEM_STAR_OUTLINE = 3030;
    int IMAGE_SYSTEM_UNBOXED = 3031;
