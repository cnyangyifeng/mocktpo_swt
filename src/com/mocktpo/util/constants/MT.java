...
public interface MT {
    ...
    int IMAGE_UNBOXED = 356;
    int IMAGE_UNCHECKED = 357;
    int IMAGE_VIEW_QUESTION = 358;
    int IMAGE_VIEW_QUESTION_HOVER = 359;
    int IMAGE_VIEW_TEXT = 360;
    int IMAGE_VIEW_TEXT_HOVER = 361;
    int IMAGE_VOLUME_OVAL = 362;
    int IMAGE_VOLUME_OVAL_HOVER = 363;
    ...
    int IMAGE_SYSTEM_MY_NOTEBOOK = 3015;
    int IMAGE_SYSTEM_MY_NOTEBOOK_HOVER = 3016;
    int IMAGE_SYSTEM_NEW_TEST = 3017;
    int IMAGE_SYSTEM_NEW_TEST_HOVER = 3018;
    int IMAGE_SYSTEM_REFERENCE_ANSWERS = 3019;
    int IMAGE_SYSTEM_REFERENCE_ANSWERS_HOVER = 3020;
    int IMAGE_SYSTEM_REPORT = 3021;
    int IMAGE_SYSTEM_REPORT_HOVER = 3022;
    int IMAGE_SYSTEM_STAR = 3023;
    int IMAGE_SYSTEM_STAR_OUTLINE = 3024;
    int IMAGE_SYSTEM_UNBOXED = 3025;
