...
public interface MT {
    ...
    int IMAGE_LOGO = 331;
    int IMAGE_NEW_TEST = 332;
    int IMAGE_NEW_TEST_HOVER = 333;
    int IMAGE_NEXT_OVAL = 334;
    int IMAGE_NEXT_OVAL_DISABLED = 335;
    int IMAGE_NEXT_OVAL_HOVER = 336;
    int IMAGE_OK_OVAL = 337;
    int IMAGE_OK_OVAL_DISABLED = 338;
    int IMAGE_OK_OVAL_HOVER = 339;
    int IMAGE_PAUSE_TEST = 340;
    int IMAGE_PAUSE_TEST_HOVER = 341;
    int IMAGE_PLAYBACK_RESPONSE = 342;
    int IMAGE_PLAYBACK_RESPONSE_DISABLED = 343;
    int IMAGE_PLAYBACK_RESPONSE_HOVER = 344;
    int IMAGE_READY_TO_ANSWER = 345;
    int IMAGE_READY_TO_ANSWER_2 = 346;
    int IMAGE_RECORD_AGAIN = 347;
    int IMAGE_RECORD_AGAIN_DISABLED = 348;
    int IMAGE_RECORD_AGAIN_HOVER = 349;
    int IMAGE_REPORT = 350;
    int IMAGE_REPORT_HOVER = 351;
    int IMAGE_RETURN = 352;
    int IMAGE_RETURN_HOVER = 353;
    int IMAGE_RETURN_TO_QUESTION = 354;
    int IMAGE_RETURN_TO_QUESTION_HOVER = 355;
    int IMAGE_REVIEW = 356;
    int IMAGE_REVIEW_HOVER = 357;
    int IMAGE_REVIEW_OVAL = 358;
    int IMAGE_REVIEW_OVAL_DISABLED = 359;
    int IMAGE_REVIEW_OVAL_HOVER = 360;
    int IMAGE_SHOW_TIME = 361;
    int IMAGE_SHOW_TIME_DISABLED = 362;
    int IMAGE_SHOW_TIME_HOVER = 363;
    int IMAGE_SPLASH = 364;
    int IMAGE_STAR = 365;
    int IMAGE_STAR_OUTLINE = 366;
    int IMAGE_STOP_RECORDING = 367;
    int IMAGE_STOP_RECORDING_HOVER = 368;
    int IMAGE_UNBOXED = 369;
    int IMAGE_UNCHECKED = 370;
