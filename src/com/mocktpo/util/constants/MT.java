...
public interface MT {
    ...
    int IMAGE_ETS_TOEFL = 319;
    int IMAGE_GO_TO_QUESTION = 320;
    int IMAGE_GO_TO_QUESTION_HOVER = 321;
    int IMAGE_HEADSET = 322;
    int IMAGE_HELP_OVAL = 323;
    int IMAGE_HELP_OVAL_DISABLED = 324;
    int IMAGE_HELP_OVAL_HOVER = 325;
    int IMAGE_HIDE_TIME = 326;
    int IMAGE_HIDE_TIME_DISABLED = 327;
    int IMAGE_HIDE_TIME_HOVER = 328;
    int IMAGE_LOGO = 329;
    int IMAGE_NEXT_OVAL = 330;
    int IMAGE_NEXT_OVAL_DISABLED = 331;
    int IMAGE_NEXT_OVAL_HOVER = 332;
    int IMAGE_OK_OVAL = 333;
    int IMAGE_OK_OVAL_DISABLED = 334;
    int IMAGE_OK_OVAL_HOVER = 335;
    int IMAGE_PAUSE_TEST = 336;
    int IMAGE_PAUSE_TEST_HOVER = 337;
    int IMAGE_PLAYBACK_RESPONSE = 338;
    int IMAGE_PLAYBACK_RESPONSE_DISABLED = 339;
    int IMAGE_PLAYBACK_RESPONSE_HOVER = 340;
    int IMAGE_READY_TO_ANSWER = 341;
    int IMAGE_READY_TO_ANSWER_2 = 342;
    int IMAGE_RECORD_AGAIN = 343;
    int IMAGE_RECORD_AGAIN_DISABLED = 344;
    int IMAGE_RECORD_AGAIN_HOVER = 345;
    int IMAGE_RETURN = 346;
    int IMAGE_RETURN_HOVER = 347;
    int IMAGE_RETURN_TO_QUESTION = 348;
    int IMAGE_RETURN_TO_QUESTION_HOVER = 349;
    int IMAGE_REVIEW = 350;
    int IMAGE_REVIEW_HOVER = 351;
    int IMAGE_REVIEW_OVAL = 352;
    int IMAGE_REVIEW_OVAL_DISABLED = 353;
    int IMAGE_REVIEW_OVAL_HOVER = 354;
    int IMAGE_SHOW_TIME = 355;
    int IMAGE_SHOW_TIME_DISABLED = 356;
    int IMAGE_SHOW_TIME_HOVER = 357;
    int IMAGE_SPLASH = 358;
    int IMAGE_STAR = 359;
    int IMAGE_STAR_EMPTY = 360;
    int IMAGE_STOP_RECORDING = 361;
    int IMAGE_STOP_RECORDING_HOVER = 362;
    int IMAGE_UNBOXED = 363;
    int IMAGE_UNCHECKED = 364;
    int IMAGE_VIEW_QUESTION = 365;
    int IMAGE_VIEW_QUESTION_HOVER = 366;
    int IMAGE_VIEW_TEXT = 367;
    int IMAGE_VIEW_TEXT_HOVER = 368;
    int IMAGE_VOLUME_OVAL = 369;
    int IMAGE_VOLUME_OVAL_HOVER = 370;
