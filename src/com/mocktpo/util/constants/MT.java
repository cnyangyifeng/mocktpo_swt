...
public interface MT {
    ...
    int IMAGE_REVIEW_OVAL_HOVER = 355;
    int IMAGE_REVIEW_OVAL_DISABLED = 356;
    int IMAGE_SETTINGS = 357;
    int IMAGE_SHOW_TIME = 358;
    int IMAGE_SHOW_TIME_HOVER = 359;
    int IMAGE_SHOW_TIME_DISABLED = 360;
    int IMAGE_SPLASH = 361;
    int IMAGE_STAR = 362;
    int IMAGE_STAR_EMPTY = 363;
    int IMAGE_STAR_HALF = 364;
    int IMAGE_STOP_RECORDING = 365;
    int IMAGE_STOP_RECORDING_HOVER = 366;
    int IMAGE_STORE = 367;
    int IMAGE_TESTS = 368;
    int IMAGE_VIEW_QUESTION = 369;
    int IMAGE_VIEW_QUESTION_HOVER = 370;
    int IMAGE_VIEW_TEXT = 371;
    int IMAGE_VIEW_TEXT_HOVER = 372;
    int IMAGE_VOLUME_OVAL = 373;
    int IMAGE_VOLUME_OVAL_HOVER = 374;
    int IMAGE_UNBOXED = 375;
    int IMAGE_UNCHECKED = 376;
