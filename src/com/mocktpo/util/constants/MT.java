...
public interface MT {
    ...
    int IMAGE_SYSTEM_EXPORT_AS_ZIP_DISABLED = 3020;
    int IMAGE_SYSTEM_EXPORT_AS_ZIP_HOVER = 3021;
    int IMAGE_SYSTEM_IMPORT = 3022;
    int IMAGE_SYSTEM_IMPORT_HOVER = 3023;
    int IMAGE_SYSTEM_NEW_TEST = 3024;
    int IMAGE_SYSTEM_NEW_TEST_HOVER = 3025;
    int IMAGE_SYSTEM_NEW_TEST_PAPER = 3026;
    int IMAGE_SYSTEM_NEW_TEST_PAPER_HOVER = 3027;
    int IMAGE_SYSTEM_PASTE = 3028;
    int IMAGE_SYSTEM_PASTE_HOVER = 3029;
    int IMAGE_SYSTEM_REPORT = 3030;
    int IMAGE_SYSTEM_REPORT_HOVER = 3031;
    int IMAGE_SYSTEM_SAVE = 3032;
    int IMAGE_SYSTEM_SAVE_HOVER = 3033;
    int IMAGE_SYSTEM_STAR = 3034;
    int IMAGE_SYSTEM_STAR_OUTLINE = 3035;
    int IMAGE_SYSTEM_STEP_GENERAL = 3036;
    int IMAGE_SYSTEM_STEP_GENERAL_CHECKED = 3037;
    int IMAGE_SYSTEM_STEP_GENERAL_DISABLED = 3038;
    int IMAGE_SYSTEM_STEP_GENERAL_HOVER = 3039;
    int IMAGE_SYSTEM_STEP_LISTENING = 3040;
    int IMAGE_SYSTEM_STEP_LISTENING_CHECKED = 3041;
    int IMAGE_SYSTEM_STEP_LISTENING_DISABLED = 3042;
    int IMAGE_SYSTEM_STEP_LISTENING_HOVER = 3043;
    int IMAGE_SYSTEM_STEP_PREVIEW = 3044;
    int IMAGE_SYSTEM_STEP_PREVIEW_CHECKED = 3045;
    int IMAGE_SYSTEM_STEP_PREVIEW_DISABLED = 3046;
    int IMAGE_SYSTEM_STEP_PREVIEW_HOVER = 3047;
    int IMAGE_SYSTEM_STEP_READING = 3048;
    int IMAGE_SYSTEM_STEP_READING_CHECKED = 3049;
    int IMAGE_SYSTEM_STEP_READING_DISABLED = 3050;
    int IMAGE_SYSTEM_STEP_READING_HOVER = 3051;
    int IMAGE_SYSTEM_STEP_SPEAKING = 3052;
    int IMAGE_SYSTEM_STEP_SPEAKING_CHECKED = 3053;
    int IMAGE_SYSTEM_STEP_SPEAKING_DISABLED = 3054;
    int IMAGE_SYSTEM_STEP_SPEAKING_HOVER = 3055;
    int IMAGE_SYSTEM_STEP_WRITING = 3056;
    int IMAGE_SYSTEM_STEP_WRITING_CHECKED = 3057;
    int IMAGE_SYSTEM_STEP_WRITING_DISABLED = 3058;
    int IMAGE_SYSTEM_STEP_WRITING_HOVER = 3059;
    int IMAGE_SYSTEM_UNBOXED = 3060;
