...
public interface MT {
    ...
    int IMAGE_HEADSET = 316;
    int IMAGE_HELP_OVAL = 317;
    int IMAGE_HELP_OVAL_HOVER = 318;
    int IMAGE_HELP_OVAL_DISABLED = 319;
    int IMAGE_HIDE_TIME = 320;
    int IMAGE_HIDE_TIME_HOVER = 321;
    int IMAGE_HIDE_TIME_DISABLED = 322;
    int IMAGE_LOGO = 323;
    int IMAGE_NEXT_OVAL = 324;
    int IMAGE_NEXT_OVAL_HOVER = 325;
    int IMAGE_NEXT_OVAL_DISABLED = 326;
    int IMAGE_OK_OVAL = 327;
    int IMAGE_OK_OVAL_HOVER = 328;
    int IMAGE_OK_OVAL_DISABLED = 329;
    int IMAGE_PAUSE_TEST = 330;
    int IMAGE_PAUSE_TEST_HOVER = 331;
    int IMAGE_RETURN = 332;
    int IMAGE_RETURN_HOVER = 333;
    int IMAGE_REVIEW = 334;
    int IMAGE_REVIEW_HOVER = 335;
    int IMAGE_REVIEW_OVAL = 336;
    int IMAGE_REVIEW_OVAL_HOVER = 337;
    int IMAGE_REVIEW_OVAL_DISABLED = 338;
    int IMAGE_SHOW_TIME = 339;
    int IMAGE_SHOW_TIME_HOVER = 340;
    int IMAGE_SHOW_TIME_DISABLED = 341;
    int IMAGE_SPLASH = 342;
    int IMAGE_VIEW_QUESTION = 343;
    int IMAGE_VIEW_QUESTION_HOVER = 344;
    int IMAGE_VIEW_TEXT = 345;
    int IMAGE_VIEW_TEXT_HOVER = 346;
    int IMAGE_VOLUME_OVAL = 347;
    int IMAGE_VOLUME_OVAL_HOVER = 348;
    int IMAGE_UNCHECKED = 349;
