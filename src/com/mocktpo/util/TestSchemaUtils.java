...
public class TestSchemaUtils {
    ...
    protected static final ResourceBundle schema = ResourceBundle.getBundle("data.schemas.s2");
    ...
    private static List<TestViewVo> initViewVos() {
        ...
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q1P"), Integer.parseInt(schema.getString("RP3Q1PO")), new StyleRangeVo(schema.getString("RP3Q1PS")), schema.getString("RP3Q1"), new StyleRangeVo(schema.getString("RP3Q1S")), schema.getString("RP3Q1CA"), schema.getString("RP3Q1CB"), schema.getString("RP3Q1CC"), schema.getString("RP3Q1CD"), schema.getString("RP3Q1F")));
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q2P"), Integer.parseInt(schema.getString("RP3Q2PO")), new StyleRangeVo(schema.getString("RP3Q2PS")), schema.getString("RP3Q2"), new StyleRangeVo(schema.getString("RP3Q2S")), schema.getString("RP3Q2CA"), schema.getString("RP3Q2CB"), schema.getString("RP3Q2CC"), schema.getString("RP3Q2CD"), schema.getString("RP3Q2F")));
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q3P"), Integer.parseInt(schema.getString("RP3Q3PO")), new StyleRangeVo(schema.getString("RP3Q3PS")), schema.getString("RP3Q3"), new StyleRangeVo(schema.getString("RP3Q3S")), schema.getString("RP3Q3CA"), schema.getString("RP3Q3CB"), schema.getString("RP3Q3CC"), schema.getString("RP3Q3CD"), schema.getString("RP3Q3F")));
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q4P"), Integer.parseInt(schema.getString("RP3Q4PO")), new StyleRangeVo(schema.getString("RP3Q4PS")), schema.getString("RP3Q4"), new StyleRangeVo(schema.getString("RP3Q4S")), schema.getString("RP3Q4CA"), schema.getString("RP3Q4CB"), schema.getString("RP3Q4CC"), schema.getString("RP3Q4CD"), schema.getString("RP3Q4F")));
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q5P"), Integer.parseInt(schema.getString("RP3Q5PO")), new StyleRangeVo(schema.getString("RP3Q5PS")), schema.getString("RP3Q5"), new StyleRangeVo(schema.getString("RP3Q5S")), schema.getString("RP3Q5CA"), schema.getString("RP3Q5CB"), schema.getString("RP3Q5CC"), schema.getString("RP3Q5CD"), schema.getString("RP3Q5F")));
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q6P"), Integer.parseInt(schema.getString("RP3Q6PO")), new StyleRangeVo(schema.getString("RP3Q6PS")), schema.getString("RP3Q6"), new StyleRangeVo(schema.getString("RP3Q6S")), schema.getString("RP3Q6CA"), schema.getString("RP3Q6CB"), schema.getString("RP3Q6CC"), schema.getString("RP3Q6CD"), schema.getString("RP3Q6F")));
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q7P"), Integer.parseInt(schema.getString("RP3Q7PO")), new StyleRangeVo(schema.getString("RP3Q7PS")), schema.getString("RP3Q7"), new StyleRangeVo(schema.getString("RP3Q7S")), schema.getString("RP3Q7CA"), schema.getString("RP3Q7CB"), schema.getString("RP3Q7CC"), schema.getString("RP3Q7CD"), schema.getString("RP3Q7F")));
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q8P"), Integer.parseInt(schema.getString("RP3Q8PO")), new StyleRangeVo(schema.getString("RP3Q8PS")), schema.getString("RP3Q8"), new StyleRangeVo(schema.getString("RP3Q8S")), schema.getString("RP3Q8CA"), schema.getString("RP3Q8CB"), schema.getString("RP3Q8CC"), schema.getString("RP3Q8CD"), schema.getString("RP3Q8F")));
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q9P"), Integer.parseInt(schema.getString("RP3Q9PO")), new StyleRangeVo(schema.getString("RP3Q9PS")), schema.getString("RP3Q9"), new StyleRangeVo(schema.getString("RP3Q9S")), schema.getString("RP3Q9CA"), schema.getString("RP3Q9CB"), schema.getString("RP3Q9CC"), schema.getString("RP3Q9CD"), schema.getString("RP3Q9F")));
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q10P"), Integer.parseInt(schema.getString("RP3Q10PO")), new StyleRangeVo(schema.getString("RP3Q10PS")), schema.getString("RP3Q10"), new StyleRangeVo(schema.getString("RP3Q10S")), schema.getString("RP3Q10CA"), schema.getString("RP3Q10CB"), schema.getString("RP3Q10CC"), schema.getString("RP3Q10CD"), schema.getString("RP3Q10F")));
        viewVos.add(initReadingQuestionView(++viewId, ++questionNumber, schema.getString("RP3H"), schema.getString("RP3Q11P"), Integer.parseInt(schema.getString("RP3Q11PO")), new StyleRangeVo(schema.getString("RP3Q11PS")), schema.getString("RP3Q11"), new StyleRangeVo(schema.getString("RP3Q11S")), schema.getString("RP3Q11CA"), schema.getString("RP3Q11CB"), schema.getString("RP3Q11CC"), schema.getString("RP3Q11CD"), schema.getString("RP3Q11F")));
