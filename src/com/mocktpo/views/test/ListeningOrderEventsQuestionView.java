...
public class ListeningOrderEventsQuestionView extends ResponsiveTestView {
    ...
    public void updateHeader() {
        ...
        skipButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent mouseEvent) {
                release();
                PersistenceUtils.saveToNextView(ListeningOrderEventsQuestionView.this);
                page.resume();
            }
        });
    }
    ...
    private class VolumeOvalButtonMouseAdapter extends MouseAdapter {
        ...
        public void mouseDown(MouseEvent e) {
            ...
            CompositeSet.decorate(volumeControl).setVisible(volumeControlVisible);
            PersistenceUtils.saveVolumeControlVisibility(ListeningOrderEventsQuestionView.this);
        }
    }
    ...
    private class VolumeControlSelectionAdapter extends SelectionAdapter {
        ...
        public void widgetSelected(SelectionEvent e) {
            ...
            PersistenceUtils.saveVolume(ListeningOrderEventsQuestionView.this, volume);
    ...
    private class AnswerCompositePropertyChangeListener implements PropertyChangeListener {
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            PersistenceUtils.saveAnswer(ListeningOrderEventsQuestionView.this, answerText);
        }
    }
