...
public class ListeningDirectionsView extends TestView {
    ...
    public void updateBody() {
        ...
        tl.setText(msgs.getString("listening_directions"));
        ...
        StyledTextVo vo = ConfigUtils.load(RC.LISTENING_DIRECTIONS_FILE, StyledTextVo.class);
