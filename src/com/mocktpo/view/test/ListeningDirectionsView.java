...
public class ListeningDirectionsView extends ResponsiveTestView {
    ...
    private class VolumeOvalButtonMouseListener implements MouseListener {
        ...
        public void mouseDown(MouseEvent e) {
            ...
            CompositeSet.decorate(volumeControl).setVisible(volumeControlVisible);
            UserTestPersistenceUtils.saveVolumeControlVisibility(ListeningDirectionsView.this);
        }
    ...
    private class VolumeControlSelectionListener implements SelectionListener {
        ...
        public void widgetSelected(SelectionEvent e) {
            ...
            UserTestPersistenceUtils.saveVolume(ListeningDirectionsView.this, volume);
    ...
    private class ContinueButtonMouseListener implements MouseListener {
        ...
        public void mouseDown(MouseEvent e) {
            release();
            UserTestPersistenceUtils.saveToNextView(ListeningDirectionsView.this);
            page.resume();
        }
