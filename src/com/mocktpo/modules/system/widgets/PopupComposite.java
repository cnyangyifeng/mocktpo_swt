 ...
 *
 * <pre>
 * PopupComposite pc = new PopupComposite(getShell());
 * Text text = new Text(pc, SWT.BORDER);
 * pc.pack();
 * pc.show(shell.toDisplay(new Point(10, 10)));
 * </pre>
 *
...
public class PopupComposite extends Composite {
    ...
    /**
     * Create a popup composite with the default {@link SWT#BORDER} style.
     *
    ...
    /**
     * Create a popup composite. The default layout is a fill layout.
     *
     * @param parent The parent shell.
    ...
    public PopupComposite(Shell parent, int style) {
        ...
        s.addShellListener(new ActivationListener());
     ...
     *
     * @param p The point where the pop-up should appear.
     */
