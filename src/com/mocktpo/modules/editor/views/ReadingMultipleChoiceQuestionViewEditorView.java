...
public class ReadingMultipleChoiceQuestionViewEditorView extends SashTestViewEditorView {
    ...
    public ReadingMultipleChoiceQuestionViewEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
