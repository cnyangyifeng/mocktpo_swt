...
public class SpeakingTaskDirectionsEditorView extends SashTestEditorView {
    ...
    public SpeakingTaskDirectionsEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
