...
public class WritingListeningMaterialEditorView extends SashTestEditorView {
    ...
    public WritingListeningMaterialEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
