...
public class ListeningMultipleResponseQuestionEditorView extends SashTestEditorView {
    ...
    public ListeningMultipleResponseQuestionEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
