...
public class IndependentWritingTaskEditorView extends SashTestEditorView {
    ...
    public IndependentWritingTaskEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
