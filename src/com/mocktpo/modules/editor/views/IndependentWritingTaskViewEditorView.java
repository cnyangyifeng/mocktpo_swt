...
public class IndependentWritingTaskViewEditorView extends SashTestViewEditorView {
    ...
    public IndependentWritingTaskViewEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
