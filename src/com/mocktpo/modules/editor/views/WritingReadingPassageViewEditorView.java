...
public class WritingReadingPassageViewEditorView extends SashTestViewEditorView {
    ...
    public WritingReadingPassageViewEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
