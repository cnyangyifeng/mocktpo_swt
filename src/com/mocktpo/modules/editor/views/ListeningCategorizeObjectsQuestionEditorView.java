...
public class ListeningCategorizeObjectsQuestionEditorView extends SashTestEditorView {
    ...
    public ListeningCategorizeObjectsQuestionEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
