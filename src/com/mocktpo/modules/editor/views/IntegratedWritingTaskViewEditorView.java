...
public class IntegratedWritingTaskViewEditorView extends SashTestViewEditorView {
    ...
    public IntegratedWritingTaskViewEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
