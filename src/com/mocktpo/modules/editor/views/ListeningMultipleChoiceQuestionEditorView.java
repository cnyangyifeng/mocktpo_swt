...
public class ListeningMultipleChoiceQuestionEditorView extends SashTestEditorView {
    ...
    public ListeningMultipleChoiceQuestionEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
