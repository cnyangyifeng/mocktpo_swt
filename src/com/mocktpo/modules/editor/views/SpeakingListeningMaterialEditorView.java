...
public class SpeakingListeningMaterialEditorView extends SashTestEditorView {
    ...
    public SpeakingListeningMaterialEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
