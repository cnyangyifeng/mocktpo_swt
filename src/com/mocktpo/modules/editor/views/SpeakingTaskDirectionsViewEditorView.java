...
public class SpeakingTaskDirectionsViewEditorView extends SashTestViewEditorView {
    ...
    public SpeakingTaskDirectionsViewEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
