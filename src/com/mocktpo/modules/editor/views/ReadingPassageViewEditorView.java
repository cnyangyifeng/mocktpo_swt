...
public class ReadingPassageViewEditorView extends SashTestViewEditorView {
    ...
    public ReadingPassageViewEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
