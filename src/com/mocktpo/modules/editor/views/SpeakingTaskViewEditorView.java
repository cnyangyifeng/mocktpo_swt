...
public class SpeakingTaskViewEditorView extends SashTestViewEditorView {
    ...
    public SpeakingTaskViewEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
