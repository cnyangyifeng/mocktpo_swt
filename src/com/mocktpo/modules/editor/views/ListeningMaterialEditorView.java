...
public class ListeningMaterialEditorView extends SashTestEditorView {
    ...
    public ListeningMaterialEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
