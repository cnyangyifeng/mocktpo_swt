...
public class ReadingProseSummaryQuestionViewEditorView extends SashTestViewEditorView {
    ...
    protected void updateRight() {
        ...
        LabelSet.decorate(directionsLabel).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setText(MT.STRING_READING_PROSE_SUMMARY_QUESTION_VIEW_DIRECTIONS);

        final Label tipsLabel = new Label(c, SWT.WRAP);
        FormDataSet.attach(tipsLabel).atLeft().atTopTo(directionsLabel).atRight();
        LabelSet.decorate(tipsLabel).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setText(MT.STRING_READING_PROSE_SUMMARY_QUESTION_VIEW_TIPS);
        ...
        StyledTextSet.decorate(questionTextWidget).setBackground(MT.COLOR_WHITE).setFocus().setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setMargins(10, 10, 10, 10).setText(vo.getStyledTextContent("question"));
        ...
        CLabelSet.decorate(choiceAPreLabel).setFont(MT.FONT_SMALL).setForeground(MT.COLOR_GREY_DARKEN_4).setText(msgs.getString("choice_a") + MT.STRING_TAB + MT.STRING_STAR);
        ...
        StyledTextSet.decorate(choiceATextWidget).setBackground(MT.COLOR_WHITE).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setMargins(10, 10, 10, 10).setText(vo.getStyledTextContent("choiceA"));
        ...
        CLabelSet.decorate(choiceBPreLabel).setFont(MT.FONT_SMALL).setForeground(MT.COLOR_GREY_DARKEN_4).setText(msgs.getString("choice_b") + MT.STRING_TAB + MT.STRING_STAR);
        ...
        StyledTextSet.decorate(choiceBTextWidget).setBackground(MT.COLOR_WHITE).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setMargins(10, 10, 10, 10).setText(vo.getStyledTextContent("choiceB"));
        ...
        CLabelSet.decorate(choiceCPreLabel).setFont(MT.FONT_SMALL).setForeground(MT.COLOR_GREY_DARKEN_4).setText(msgs.getString("choice_c") + MT.STRING_TAB + MT.STRING_STAR);
        ...
        StyledTextSet.decorate(choiceCTextWidget).setBackground(MT.COLOR_WHITE).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setMargins(10, 10, 10, 10).setText(vo.getStyledTextContent("choiceC"));
        ...
        CLabelSet.decorate(choiceDPreLabel).setFont(MT.FONT_SMALL).setForeground(MT.COLOR_GREY_DARKEN_4).setText(msgs.getString("choice_d") + MT.STRING_TAB + MT.STRING_STAR);
        ...
        StyledTextSet.decorate(choiceDTextWidget).setBackground(MT.COLOR_WHITE).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setMargins(10, 10, 10, 10).setText(vo.getStyledTextContent("choiceD"));
        ...
        CLabelSet.decorate(choiceEPreLabel).setFont(MT.FONT_SMALL).setForeground(MT.COLOR_GREY_DARKEN_4).setText(msgs.getString("choice_e") + MT.STRING_TAB + MT.STRING_STAR);
        ...
        StyledTextSet.decorate(choiceETextWidget).setBackground(MT.COLOR_WHITE).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setMargins(10, 10, 10, 10).setText(vo.getStyledTextContent("choiceE"));
        ...
        CLabelSet.decorate(choiceFPreLabel).setFont(MT.FONT_SMALL).setForeground(MT.COLOR_GREY_DARKEN_4).setText(msgs.getString("choice_f") + MT.STRING_TAB + MT.STRING_STAR);
        ...
        StyledTextSet.decorate(choiceFTextWidget).setBackground(MT.COLOR_WHITE).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setMargins(10, 10, 10, 10).setText(vo.getStyledTextContent("choiceF"));
