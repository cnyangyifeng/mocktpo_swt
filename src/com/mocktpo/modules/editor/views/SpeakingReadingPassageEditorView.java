...
public class SpeakingReadingPassageEditorView extends SashTestEditorView {
    ...
    public SpeakingReadingPassageEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
