...
public class ListeningMultipleResponseQuestionViewEditorView extends SashTestViewEditorView {
    ...
    public ListeningMultipleResponseQuestionViewEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
    ...
    protected void updateRight() {
        ...
        FormDataSet.attach(questionTextWidget).atLeft().atTopTo(highlightQuestionButton).atRight().withHeight(LC.SYSTEM_TRIPLE_LINES_TEXT_WIDGET_HEIGHT);
        ...
        FormDataSet.attach(footnotePreLabel).atLeft().atTopTo(choiceDTextWidget, 10).atRight().withHeight(LC.SYSTEM_SINGLE_LINE_TEXT_WIDGET_HEIGHT);
        CLabelSet.decorate(footnotePreLabel).setFont(MT.FONT_SMALL).setForeground(MT.COLOR_GRAY_DARKEN_2).setText(msgs.getString("footnote"));

        footnoteTextWidget = new StyledText(c, SWT.SINGLE);
        FormDataSet.attach(footnoteTextWidget).atLeft().atTopTo(footnotePreLabel).atRight().withHeight(LC.SYSTEM_SINGLE_LINE_TEXT_WIDGET_HEIGHT);
        StyledTextSet.decorate(footnoteTextWidget).setBackground(MT.COLOR_GREY_LIGHTEN_4).setEditable(false).setEnabled(false).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_BLUE_GREY_DARKEN_4).setMargins(10, 10, 10, 10).setNoCaret().setText(vo.getStyledTextContent("footnote"));
    ...
    private class HighlightPassageButtonMouseListener extends MouseAdapter {
        ...
        public void mouseDown(MouseEvent e) {
            ...
            styles.add(new StyleRangeVo(p.x, p.y, 0, MT.COLOR_BLUE_GREY_DARKEN_4, MT.COLOR_HIGHLIGHTED, false, null));
