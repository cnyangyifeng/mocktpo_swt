...
public class ListeningMultipleResponseQuestionViewEditorView extends SashTestViewEditorView {
    ...
    protected void updateRight() {
        ...
        CLabelSet.decorate(footnotePreLabel).setFont(MT.FONT_SMALL).setForeground(MT.COLOR_GREY_DARKEN_4).setText(msgs.getString("footnote"));
        ...
        StyledTextSet.decorate(footnoteTextWidget).setBackground(MT.COLOR_GREY_LIGHTEN_4).setEditable(false).setEnabled(false).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setMargins(10, 10, 10, 10).setNoCaret().setText(vo.getStyledTextContent("footnote"));
    ...
    private class HighlightPassageButtonMouseListener extends MouseAdapter {
        ...
        public void mouseDown(MouseEvent e) {
            ...
            styles.add(new StyleRangeVo(p.x, p.y, 0, MT.COLOR_GREY_DARKEN_4, MT.COLOR_HIGHLIGHTED, false, null));
