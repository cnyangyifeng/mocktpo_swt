...
public class ListeningSortEventsQuestionViewEditorView extends SashTestViewEditorView {
    ...
    public ListeningSortEventsQuestionViewEditorView(SashTestEditorLayer layer, int style, TestViewVo vo) {
