...
public class TestIntroView extends ResponsiveTestView {
    ...
    protected void updateBody() {
        ...
        StyledTextSet.decorate(descriptionTextWidget).setAlignment(SWT.CENTER).setEditable(false).setEnabled(false).setFont(MT.FONT_MEDIUM).setLineSpacing(5).setText(vo.getStyledTextContent("description"));
