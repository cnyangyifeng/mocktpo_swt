...
public class SpeakingListeningMaterialView extends ResponsiveTestView {
    ...
    public SpeakingListeningMaterialView(TestPage page, int style) {
        super(page, style);
    }
    ...
    protected void updateBody() {
        ...
        pc.addPaintListener(new BorderedCompositePaintListener(MT.COLOR_GRAY_DARKEN_2));
    ...
    private class VolumeOvalButtonMouseAdapter extends MouseAdapter {
        ...
        public void mouseDown(MouseEvent e) {
            ...
            CompositeSet.decorate(volumeControl).setVisible(volumeControlVisible);
            PersistenceUtils.saveVolumeControlVisibility(SpeakingListeningMaterialView.this);
        }
    }
    ...
    private class VolumeControlSelectionAdapter extends SelectionAdapter {
        ...
        public void widgetSelected(SelectionEvent e) {
            ...
            PersistenceUtils.saveVolume(SpeakingListeningMaterialView.this, volume);
