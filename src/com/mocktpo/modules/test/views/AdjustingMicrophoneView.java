...
public class AdjustingMicrophoneView extends StackTestView {
    ...
    private Composite initRecordingSubView() {
        ...
        StyledTextSet.decorate(headingTextWidget).setAlignment(SWT.CENTER).setEditable(false).setEnabled(false).setFont(MT.FONT_SERIF_HEADING).setForeground(MT.COLOR_GREY_DARKEN_4).setText(vo.getStyledTextContent("heading"));
        ...
        StyledTextSet.decorate(footnoteTextWidget).setAlignment(SWT.CENTER).setEditable(false).setEnabled(false).setFont(MT.FONT_SERIF_ITALIC_TEXT).setForeground(MT.COLOR_GREY_DARKEN_4).setLineSpacing(5).setMarginHeight(20).setText(vo.getStyledTextContent("footnote"));
        footnoteTextWidget.addPaintListener(new BorderedCompositePaintListener(MT.COLOR_GREY_DARKEN_4));
        ...
        CLabelSet.decorate(timerHeader).setBackground(MT.COLOR_GREY_DARKEN_4).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_WHITE).setMargins(5).setText("RESPONSE TIME");
        ...
        CLabelSet.decorate(timerLabel).setBackground(MT.COLOR_WHITE).setFont(MT.FONT_MEDIUM).setForeground(MT.COLOR_GREY_DARKEN_4).setMargins(5).setText(TimeUtils.displayTimePeriod(recorderCountDown));
    ...
    private Composite initResponseSubView() {
        ...
        StyledTextSet.decorate(responseTextWidget).setEditable(false).setEnabled(false).setFont(MT.FONT_MEDIUM).setLineSpacing(5).setText(vo.getStyledTextContent("response"));
