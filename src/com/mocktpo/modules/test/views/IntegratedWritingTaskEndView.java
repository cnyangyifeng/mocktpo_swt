...
public class IntegratedWritingTaskEndView extends ResponsiveTestView {
    ...
    public IntegratedWritingTaskEndView(TestPage page, int style) {
        super(page, style);
    }
    ...
    private class ContinueButtonMouseAdapter extends MouseAdapter {
        ...
        public void mouseDown(MouseEvent e) {
            release();
            PersistenceUtils.saveToNextView(IntegratedWritingTaskEndView.this);
            page.resume();
        }
    }
    ...
    private class ReturnButtonMouseAdapter extends MouseAdapter {
        ...
        public void mouseDown(MouseEvent e) {
            release();
            PersistenceUtils.saveToPreviousView(IntegratedWritingTaskEndView.this);
            page.resume();
        }
    }
}
