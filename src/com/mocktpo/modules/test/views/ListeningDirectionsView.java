...
public class ListeningDirectionsView extends ResponsiveTestView {
    ...
    private class VolumeOvalButtonMouseAdapter extends MouseAdapter {
        ...
        public void mouseDown(MouseEvent e) {
            ...
            CompositeSet.decorate(volumeControl).setVisible(volumeControlVisible);
            PersistenceUtils.saveVolumeControlVisibility(ListeningDirectionsView.this);
        }
    }
    ...
    private class VolumeControlSelectionAdapter extends SelectionAdapter {
        ...
        public void widgetSelected(SelectionEvent e) {
            ...
            PersistenceUtils.saveVolume(ListeningDirectionsView.this, volume);
    ...
    private class ContinueButtonMouseAdapter extends MouseAdapter {
        ...
        public void mouseDown(MouseEvent e) {
            release();
            PersistenceUtils.saveToNextView(ListeningDirectionsView.this);
            page.resume();
        }
    }
}
