...
public class ReadingReviewView extends Composite {
    ...
    private void updateBody() {
        ...
        for (TestViewVo vo : page.getTestVo().getViewVos()) {
        ...
        LabelSet.decorate(bottomTableBorder).setBackground(MT.COLOR_GREY_DARKEN_1);
    }
    ...
    private class GoToQuestionButtonMouseAdapter extends MouseAdapter {
        ...
        @Override
        public void mouseDown(MouseEvent e) {
            if (selectedViewId == page.getTestVo().findFirstViewIdByViewType(VT.VIEW_TYPE_READING_SECTION_END)) {
                return;
            }
