...
public class ChangingVolumeView extends ResponsiveTestView {
    ...
    protected void updateBody() {
        ...
        StyledTextSet.decorate(headingTextWidget).setAlignment(SWT.CENTER).setEditable(false).setEnabled(false).setFont(MT.FONT_SERIF_HEADING).setForeground(MT.COLOR_INDIGO).setText(vo.getStyledTextContent("heading"));
        ...
        StyledTextSet.decorate(footnoteTextWidget).setAlignment(SWT.CENTER).setEditable(false).setEnabled(false).setFont(MT.FONT_SERIF_ITALIC_TEXT).setForeground(MT.COLOR_INDIGO).setLineSpacing(5).setMarginHeight(50).setText(vo.getStyledTextContent("footnote"));
