...
public class IndependentWritingTaskEndView extends ResponsiveTestView {
    ...
    public void updateBody() {
        ...
        StyledTextSet.decorate(descriptionTextWidget).setEditable(false).setEnabled(false).setFont(MT.FONT_MEDIUM_BOLD).setLineSpacing(5).setText(vo.getStyledText("description"));
    }
