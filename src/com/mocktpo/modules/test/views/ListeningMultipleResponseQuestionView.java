...
public class ListeningMultipleResponseQuestionView extends ResponsiveTestView {
    ...
    public ListeningMultipleResponseQuestionView(TestPage page, int style) {
        super(page, style);
    }
    ...
    protected void updateHeader() {
        ...
        skipButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent mouseEvent) {
                release();
                PersistenceUtils.saveToNextView(ListeningMultipleResponseQuestionView.this);
                page.resume();
            }
        });
    }
    ...
    private void updateWidgetsForAnswers() {
        ...
        logger.info("[Listening Multiple Response Question {}] Answers: ({}, {}, {})", vo.getQuestionNumberInSection(), answer1, answer2, answer3);
    }
    ...
    private class VolumeOvalButtonMouseAdapter extends MouseAdapter {
        ...
        public void mouseDown(MouseEvent e) {
            ...
            CompositeSet.decorate(volumeControl).setVisible(volumeControlVisible);
            PersistenceUtils.saveVolumeControlVisibility(ListeningMultipleResponseQuestionView.this);
        }
    }
    ...
    private class VolumeControlSelectionAdapter extends SelectionAdapter {
        ...
        public void widgetSelected(SelectionEvent e) {
            ...
            PersistenceUtils.saveVolume(ListeningMultipleResponseQuestionView.this, volume);
    ...
    private class ChooseAnswerAdapter extends MouseAdapter {
        ...
        public void mouseDown(MouseEvent e) {
            ...
            if (vo.getTotalAnswerCount() == 2) {
                ...
                logger.info("[Listening Multiple Response Question {}] Answers: ({}, {})", vo.getQuestionNumberInSection(), answer1, answer2);
            ...
            PersistenceUtils.saveAnswer(ListeningMultipleResponseQuestionView.this, answerText);
        }
    }
