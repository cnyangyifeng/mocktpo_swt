...
public class TestPage extends Composite {
    ...
    public TestPage(Composite parent, int style, UserTestSession userTestSession) {
        ...
        this.testVo = JSONSUtils.pullFromTest(this.userTestSession.getFileAlias(), TestVo.class);
        init();
    }
    ...
    public void resume() {
        this.testVo = JSONSUtils.pullFromTest(userTestSession.getFileAlias(), TestVo.class);
        if (testVo != null) {
